...
- Multi-moon stability: spacing checks & mean-motion resonance warnings

Plus: save & compare worlds side by side, copy as Markdown, share a world via URL hash, RU/EN switch, inputs persisted in localStorage.
